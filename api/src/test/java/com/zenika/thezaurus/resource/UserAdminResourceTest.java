...
public class UserAdminResourceTest {
    ...
    public void testListUsersWithRolesAsAdmin() throws Exception {
        Mockito.when(userRepository.findAll(Mockito.anyInt()))
                .thenReturn(List.of(
    ...
    @Test
    @TestSecurity(
            user = "consultant@zenika.com",
            roles = {Role.Names.CONSULTANT})
    public void testListUsersForbiddenForConsultant() {
        given().when().get("/api/admin/users").then().statusCode(403);
    }
    ...
    public void testUpdateRolesAsAdmin() throws Exception {
        ...
        given().contentType(ContentType.JSON)
                ...
                .when()
                .put("/api/admin/users/jane@zenika.com/roles")
                .then()
                .statusCode(200)
    ...
    public void testUpdateRolesUnknownUserReturns404() throws Exception {
        ...
        given().contentType(ContentType.JSON)
                ...
                .when()
                .put("/api/admin/users/ghost@zenika.com/roles")
                .then()
                .statusCode(404);
    }
    ...
    @TestSecurity(
            user = "consultant@zenika.com",
            roles = {Role.Names.DT, Role.Names.CONSULTANT})
